...
app.get('/product/view/:id', async (req, res) => {
    const id = req.params.id
...
app.get('/product/edit/:id', async (req, res) => {
    ...
    try {
        ...
        res.render('editProducts', { product: product.get({ plain: true })})
...
app.post('/product/update', async (req, res) => {
    ...
    // update: método usado para atualizar um dado, podem ser um dado específico usando o where
...
// serve para rodar o nosso app juntamente com o banco de dados
conn.sync()
    .then(() => {
        app.listen(3000)
    })
